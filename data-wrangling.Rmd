...
```{r}
new_data$night_2020mean[new_data$REGION == 509] <- 55.10761836120293
new_data$night_2020mean[new_data$REGION == 508] <- 0.003761738761336278
new_data$night_2020mean[new_data$REGION == 507] <- 0.008696207966718536 + 0.0004609012817408169
new_data$night_2020mean[new_data$REGION == 506] <- 0.0023915081647602424
new_data$night_2020mean[new_data$REGION == 505] <- 0.031167408437528177
new_data$night_2020mean[new_data$REGION == 504] <- 0.08363276347844056
new_data$night_2020mean[new_data$REGION == 503] <- 0.05711395955214011
new_data$night_2020mean[new_data$REGION == 502] <- 0.23817656456054812
new_data$night_2020mean[new_data$REGION == 501] <- 0.0677829536032446
