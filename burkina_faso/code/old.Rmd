...
```{r}
r4 = read_sav("/Users/andyouyang/Documents/research/burkina_faso/afrobarometer_bfo_r4_2008.sav")
r5 = read_sav("/Users/andyouyang/Documents/research/burkina_faso/afrobarometer_bfo_r5_2012.sav")
r6 = read_sav("/Users/andyouyang/Documents/research/burkina_faso/afrobarometer_bfo_r6_2015.sav")
r7 = read_sav("/Users/andyouyang/Documents/research/burkina_faso/afrobarometer_bfo_r7_2018.sav")
r8 = read_sav("/Users/andyouyang/Documents/research/burkina_faso/afrobarometer_bfo_r8_2021.sav")
r9 = read_sav("/Users/andyouyang/Documents/research/burkina_faso/afrobarometer_bfo_r9_2022.sav")
...
perf <- c(# sum(r1_dupe$parvot == 1) / sum(r1_dupe$parvot), sum(r3_dupe$Q30 == 1) / sum(r3_dupe$Q30),
             (sum(r4_dupe$Q23D == 1) / sum(r4_dupe$Q23D)), sum(r5_dupe$Q27 == 1) / sum(r5_dupe$Q27), 
             sum(r6_dupe$Q21 == 1) / sum(r6_dupe$Q21), sum(r7_dupe$Q22 == 1) / sum(r7_dupe$Q22), 
             sum(r8_dupe$Q13 == 3) / sum(r8_dupe$Q13), sum(r9_dupe$Q13 == 3) / sum(r9_dupe$Q13))
