...
# model 6 - model 5 + fixed effects for ethnicity and region of residence 
...
```{r}
r6 <- lm(Q29B ~ corrupt + deprivation + vio_97_21 + Q1 + Q37H + Q100 + Q94 + night_2020mean + REGION + Q84A, data = data)
summary(r6)
AIC(r6)
```
